...
export declare class SDKProvider extends MetaMaskInpageProvider {
    ...
    constructor({ connectionStream, shouldSendMetadata, debug, autoRequestAccounts, }: SDKProviderProps);
    forceInitializeState(): Promise<void>;
    _setConnected(): void;
    getState(): import("@metamask/providers/dist/BaseProvider").BaseProviderState;
