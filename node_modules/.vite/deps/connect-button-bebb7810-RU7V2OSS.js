...
var StyleMapDirective = class extends Directive {
  constructor(partInfo) {
    var _a5;
    super(partInfo);
    if (partInfo.type !== PartType.ATTRIBUTE || partInfo.name !== "style" || ((_a5 = partInfo.strings) === null || _a5 === void 0 ? void 0 : _a5.length) > 2) {
...
// node_modules/@radixdlt/radix-dapp-toolkit/dist/connect-button-bebb7810.mjs
css`
  :host {
    /* Core colors */
...
var F = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? Ae(o, a) : o, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(o, a, t) : n(t)) || t);
  return i && t && xe(o, a, t), t;
};
var E = class extends LitElement {
  constructor() {
    super(...arguments), this.theme = u.light, this.active = "sharing";
  }
  onClick(e, o) {
    this.dispatchEvent(
      new CustomEvent("onClick", {
        detail: { value: e, event: o },
        bubbles: true,
        composed: true
      })
    );
...
var w = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? me(o, a) : o, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(o, a, t) : n(t)) || t);
  return i && t && De(o, a, t), t;
};
var m = class extends LitElement {
  constructor() {
    super(...arguments), this.mode = u.light, this.connected = false, this.compact = false, this.isMobile = false, this.height = 0;
  }
  connectedCallback() {
  ...
  drawPopover() {
    const e = this.mode === "light" ? "#D9D9D9" : "#808080", o = this.height, a = 13, i = 8, t = 344, d2 = o, n = 12, D = n / 2, se = `
      ...
      </linearGradient>`, Me = (Y, B, H) => `
      L ${Y - H} ${B} 
      L ${Y} 1
      L ${Y + H} ${B}`, Ie = this.compact ? t - 30 : 300, pe = `
    <svg viewBox="0 0 345 ${o + 1}"  fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none"  >
        <path
            d="${[
      `M ${a} ${i}`,
      Me(Ie, i, 7),
      ...
      `C ${t - D} ${i} ${t} ${i + D} ${t} ${i + n}`,
      `L ${t} ${d2 - n}`,
      `C ${t} ${d2 - D} ${t - D} ${d2} ${t - n} ${d2}`,
      `L ${a} ${d2}`,
      `C ${a - D} ${d2} ${a - n} ${d2 - D} ${a - n} ${d2 - n}`,
      `L ${a - n} ${i + n}`,
      `C ${a - n} ${i + D} ${a - D} ${i} ${a} ${i}`,
      "Z"
    ].join(" ")}"
    ...
    `;
    return `data:image/svg+xml;base64,${be(pe)}`;
  }
  render() {
    return this.isMobile ? html`<div id="radix-mobile-popover-content">
          <button
            id="close-button"
            @click=${() => {
      this.closePopover();
...
m.styles = [
  ...
  css`
      ...
      #close-button {
        -webkit-mask-image: url(${unsafeCSS(P)});
        mask-image: url(${unsafeCSS(P)});
...
], m.prototype, "connected", 2);
w([
  property({
    type: Boolean
  })
], m.prototype, "compact", 2);
w([
  property({
    type: Boolean
  })
...
var ze = 32;
var G = 138;
var J = html`<div class="loading-spinner-container">
...
var W = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? je(o, a) : o, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(o, a, t) : n(t)) || t);
  return i && t && Ze(o, a, t), t;
};
var y = class extends LitElement {
  constructor() {
    super(...arguments), this.status = k.default, this.connected = false, this.fullWidth = false, this.theme = "radix-blue";
  }
  onClick(e) {
    this.dispatchEvent(
      new CustomEvent("onClick", {
  ...
  disconnectedCallback() {
    ...
    (e = this.resizeObserver) == null || e.unobserve(o);
  }
  render() {
    const e = () => this.status === k.pending && this.connected ? html`${J} <slot></slot>` : this.status === k.pending ? J : !this.connected && ["success", "error"].includes(this.status) ? "" : html`<slot></slot>`, o = this.status !== "pending" && !this.connected, a = this.connected;
    return html`
      <button
        @click=${this.onClick}
        class=${classMap({
...
y.styles = [
  ...
  css`
      ...
      button.logo::before {
        content: '';
        mask-image: url(${unsafeCSS(K)});
        -webkit-mask-image: url(${unsafeCSS(K)});
      }
      ...
      button.gradient {
        ...
        background-color: var(--color-radix-blue-2);
        color: var(--color-light);
        background-image: url(${unsafeCSS(ye)});
        padding-right: 7px;
      }
      ...
      :host([status='default']) > button.gradient::before {
        mask-image: url(${unsafeCSS(q)});
        -webkit-mask-image: url(${unsafeCSS(q)});
        width: 22px;
        min-width: 22px;
        height: 22px;
      ...
      :host([status='error']) > button::before {
        mask-image: url(${unsafeCSS(_)});
        -webkit-mask-image: url(${unsafeCSS(_)});
        width: 22px;
        min-width: 22px;
        height: 22px;
        -webkit-mask-position: center;
      ...
      @container (width < ${G - 0.1}px) {
        ...
        button.gradient {
          background-image: url(${unsafeCSS(Ce)});
          padding: 0;
        }
        button.logo::before {
          font-size: 16px;
...
var ce = (e, o = " ") => {
  const a = new Date(Number(e)), i = ve(a), t = a.toLocaleTimeString("en-Gb", {
    // en-GB is causing midnight to be 00:00
    hour: "numeric",
    minute: "numeric",
    hour12: false
  });
  return i ? `Today${o}${t}` : `${a.getDate()} ${a.toLocaleString("en-US", {
    month: "short"
  })}${o}${t}`;
};
...
var R = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? ke(o, a) : o, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(o, a, t) : n(t)) || t);
  return i && t && Ve(o, a, t), t;
};
var C = class extends LitElement {
  constructor() {
    super(...arguments), this.mode = u.light, this.header = "";
  }
  render() {
    const e = () => this.timestamp ? html`<div class="timestamp">${ce(this.timestamp)}</div>` : "", o = `${this.icon ? "30px" : ""} 1fr ${this.timestamp ? "60px" : ""}`;
    return html`<div class="card" style=${styleMap({ gridTemplateColumns: o })}>
      <i></i>
      <div class="content">
...
C.styles = [
  ...
  css`
      ...
      :host([icon='unchecked']) i::before {
        -webkit-mask-image: url(${unsafeCSS(ee)});
        mask-image: url(${unsafeCSS(ee)});
        width: 24px;
        height: 24px;
      }

      :host([icon='pending']) i::before {
        -webkit-mask-image: url(${unsafeCSS(oe)});
        mask-image: url(${unsafeCSS(oe)});
        width: 24px;
        height: 24px;
      }

      :host([icon='checked']) i::before {
        -webkit-mask-image: url(${unsafeCSS(te)});
        mask-image: url(${unsafeCSS(te)});
        width: 24px;
        height: 24px;
      }

      :host([icon='error']) i::before {
        -webkit-mask-image: url(${unsafeCSS(ie)});
        mask-image: url(${unsafeCSS(ie)});
        width: 24px;
        height: 24px;
      }
    `
...
var f = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? we(o, a) : o, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(o, a, t) : n(t)) || t);
  return i && t && Ue(o, a, t), t;
};
var U = class extends LitElement {
  constructor() {
    super(...arguments), this.mode = u.light, this.href = "", this.displayText = "";
  }
  render() {
...
U.styles = [
  ...
  css`
      ...
      .icon-north-east-arrow::before {
        ...
        mask-size: cover;
        background-color: var(--radix-card-text-dimmed-color);
        -webkit-mask-image: url(${unsafeCSS(ae)});
        mask-image: url(${unsafeCSS(ae)});
        width: 16px;
        height: 16px;
      }
    `
...
var ge = (e) => e ? `${e.slice(0, 4)}...${e.slice(
  e.length - 6,
  e.length
)}` : "";
...
var O = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? We(o, a) : o, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(o, a, t) : n(t)) || t);
  return i && t && Le(o, a, t), t;
};
var Z = class extends LitElement {
  constructor() {
    super(...arguments), this.mode = u.light, this.address = "", this.label = "", this.appearanceId = 0;
  }
...
Z.styles = [
  ...
  css`
      ...
      i {
        background-image: url(${unsafeCSS(Ee)});
        display: inline-block;
        background-repeat: no-repeat;
        background-size: cover;
...
var z = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? Oe(o, a) : o, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(o, a, t) : n(t)) || t);
  return i && t && Re(o, a, t), t;
};
var x = class extends LitElement {
  constructor() {
    super(...arguments), this.mode = u.light, this.type = "dataRequest", this.status = "pending", this.showCancel = false, this.timestamp = "", this.id = "", this.transactionIntentHash = "";
  }
  render() {
    const e = this.getIconFromStatus(), o = this.getStylingFromStatus(), a = {
      sendTransaction: {
    ...
    return html`<radix-card
      ...
      header="${a[this.type][this.status]}"
    >
      ${a[this.type].content}
    </radix-card>`;
  }
  getRequestContentTemplate(e) {
    return this.status === "pending" ? html`<div class="request-content">
          ${e}
          ${this.showCancel ? html`<div class="cancel" @click=${this.onCancel}>Cancel</div>` : ""}
        </div>` : "";
  }
  getIconFromStatus() {
  ...
  renderTxIntentHash() {
    return this.transactionIntentHash ? html`<div class="transaction">
          <span class="text-dimmed">ID:</span>
          <radix-link
            displayText="${ge(this.transactionIntentHash)}"
            mode=${this.mode}
            @click=${(e) => {
      e.preventDefault(), this.dispatchEvent(
        new CustomEvent("onLinkClick", {
...
var X = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? Ge(o, a) : o, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(o, a, t) : n(t)) || t);
  return i && t && Qe(o, a, t), t;
};
var L = class extends LitElement {
  constructor() {
    super(...arguments), this.mode = u.light, this.requestItems = [];
  }
  render() {
    return (this.requestItems || []).map(
      (e) => html`<radix-request-card
        type="${e.type}"
        status="${e.status}"
        id="${e.id}"
...
var v = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? Ye(o, a) : o, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(o, a, t) : n(t)) || t);
  return i && t && fe(o, a, t), t;
};
var A = class extends LitElement {
  constructor() {
    super(...arguments), this.mode = u.light, this.isMobile = false, this.status = k.default, this.isWalletLinked = false, this.isExtensionAvailable = false, this.requestItems = [];
  }
  render() {
    let e = this.renderConnectTemplate();
    return this.isMobile ? e = this.renderMobileTemplate() : this.isExtensionAvailable ? this.isWalletLinked ? this.status === k.pending && (e = this.renderRequestItemsTemplate()) : e = this.renderCeNotLinkedTemplate() : e = this.renderCeNotInstalledTemplate(), html`
      <div class="wrapper connect-your-wallet">
        <img class="logo" src=${Se} />
...
], A.prototype, "isWalletLinked", 2);
v([
  property({
    type: Boolean
  })
], A.prototype, "isExtensionAvailable", 2);
v([
  property({
    type: Array
  })
], A.prototype, "requestItems", 2);
A = v([
...
var S = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? Be(o, a) : o, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(o, a, t) : n(t)) || t);
  return i && t && Xe(o, a, t), t;
};
var h = class extends LitElement {
  constructor() {
    super(...arguments), this.mode = u.light, this.persona = "", this.personaData = [];
  }
  render() {
    return html`<radix-card mode=${this.mode}>
      ...
      backgroundImage: `url(${unsafeCSS(this.avatarUrl)})`
        ...
        <div class="content">
          ...
          <ul>
            ${(this.personaData || []).map((e) => html`<li>${e}</li>`)}
          </ul>
        </div>
      </div></radix-card
    >`;
...
h.styles = [
  ...
  css`
      ...
      .placeholder {
        width: 64px;
        height: 64px;
        background-image: url(${unsafeCSS(Fe)});
      }
...
], h.prototype, "persona", 2);
S([
  property({
    type: String
  })
], h.prototype, "avatarUrl", 2);
S([
  property({
    type: Array
  })
], h.prototype, "personaData", 2);
h = S([
...
var V = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? Pe(o, a) : o, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(o, a, t) : n(t)) || t);
  return i && t && He(o, a, t), t;
};
var b = class extends LitElement {
  constructor() {
    super(...arguments), this.mode = u.light, this.avatarUrl = "", this.persona = "", this.dAppName = "", this.personaData = [], this.accounts = [];
  }
  onUpdateData(e) {
    this.dispatchEvent(
  ...
  render() {
    return html` <div class="header">Sharing with ${this.dAppName}</div>
      <div class="content">
        ...
        <div>
          ${(this.accounts || []).map(
      ({ label: e, address: o, appearanceId: a }) => html`<radix-account
                label=${e}
                address=${o}
                appearanceId=${a}
              ></radix-account>`
...
b.styles = [
  ...
  css`
      ...
      #update-data::before {
        -webkit-mask-image: url(${unsafeCSS(re)});
        mask-image: url(${unsafeCSS(re)});
      }

      #logout::before {
        -webkit-mask-image: url(${unsafeCSS(ne)});
        mask-image: url(${unsafeCSS(ne)});
      }
    `
];
V([
...
var Q = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? Ke(o, a) : o, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(o, a, t) : n(t)) || t);
  return i && t && Je(o, a, t), t;
};
var j = class extends LitElement {
  constructor() {
    super(...arguments), this.mode = u.light, this.requestItems = [], this.dAppName = "", this.loggedInTimestamp = "";
  }
  render() {
    return html`
      <div class="header">Connected to ${this.dAppName}</div>
      <slot name="subheader"></slot>
      ${this.loggedInTimestamp ? html`<div class="subheader">
            Since logged in: ${ce(this.loggedInTimestamp, ", ")}
          </div>` : ""}
      <div class="content">
...
Q([
  property({ type: Array })
], j.prototype, "requestItems", 2);
Q([
  property({
    type: String
  })
], j.prototype, "dAppName", 2);
Q([
  property({
    type: String
  })
], j.prototype, "loggedInTimestamp", 2);
j = Q([
...
var s = (e, o, a, i) => {
  for (var t = i > 1 ? void 0 : i ? $e(o, a) : o, d2 = e.length - 1, n; d2 >= 0; d2--)
    (n = e[d2]) && (t = (i ? n(o, a, t) : n(t)) || t);
  return i && t && qe(o, a, t), t;
};
var l = class extends LitElement {
  constructor() {
    super(), this.theme = "radix-blue", this.dAppName = "", this.personaLabel = "", this.connected = false, this.status = k.default, this.loggedInTimestamp = "", this.showPopoverMenu = false, this.requestItems = [], this.accounts = [], this.personaData = [], this.isMobile = false, this.isWalletLinked = false, this.isExtensionAvailable = false, this.fullWidth = false, this.activeTab = "sharing", this.mode = "light", this.avatarUrl = "", this.compact = false, this.windowClickEventHandler = (e) => {
      this.showPopoverMenu && (this.contains(e.target) || (this.showPopoverMenu = false));
  ...
  connectButtonTemplate() {
    ...
    return html` <radix-button
      ...
      @onResize=${(o) => {
      this.compact = o.detail.offsetWidth === 40;
    }}
  ...
  popoverTemplate() {
    return this.showPopoverMenu ? html` <radix-popover
      mode="${this.mode}"
      ?connected=${this.connected}
...
export {
  l as ConnectButton,
  u as RadixButtonMode,
  k as RadixButtonStatus
};
...
lit-html/development/directives/style-map.js:
   ...
   *)
*/
//# sourceMappingURL=connect-button-bebb7810-RU7V2OSS.js.map
