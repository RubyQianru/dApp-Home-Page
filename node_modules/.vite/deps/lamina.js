import {
  ...
  useDrag
} from "./chunk-PLUN4NI7.js";
import {
  create,
  extend
} from "./chunk-SXQ3PAKE.js";
import {
  Color,
  Material,
  MathUtils,
  ...
  Vector3,
  Vector4
} from "./chunk-QJW4LF2O.js";
import {
  require_client
} from "./chunk-G2TQPM5F.js";
import {
  arrow,
  autoUpdate,
  flip,
  ...
  size,
  useFloating
} from "./chunk-TQJ5SUSU.js";
import {
  require_react_dom
} from "./chunk-V4FM34TX.js";
import {
  require_prop_types
...
var require_builtins_300es = __commonJS({
  "node_modules/glsl-tokenizer/lib/builtins-300es.js"(exports, module) {
    ...
    v100 = v100.slice().filter(function(b4) {
      return !/^(gl\_|texture)/.test(b4);
    });
...
var require_glsl_tokenizer = __commonJS({
  "node_modules/glsl-tokenizer/index.js"(exports, module) {
    ...
    function tokenize3(opt) {
      var i4 = 0, total = 0, mode = NORMAL, c4, last, content = [], tokens = [], token_idx = 0, token_offs = 0, line = 1, col = 0, start = 0, isnum = false, isoperator = false, input = "", len;
      opt = opt || {};
      ...
      for (var i4 = 0; i4 < allBuiltins.length; i4++) {
        builtinsDict[allBuiltins[i4]] = true;
      }
      for (var i4 = 0; i4 < allLiterals.length; i4++) {
        literalsDict[allLiterals[i4]] = true;
      }
      ...
      function operator() {
        ...
        var is_composite_operator = content.length === 2 && c4 !== "=";
        if (/[\w_\d\s]/.test(c4) || is_composite_operator) {
          while (determine_operator(content))
            ;
          mode = NORMAL;
          return i4;
      ...
      function integer() {
        ...
        if (c4 === "x" && content.length === 1 && content[0] === "0") {
          mode = HEX;
          content.push(c4);
          last = c4;
          return i4 + 1;
  ...
  "node_modules/glsl-token-depth/index.js"(exports, module) {
    ...
    function getTokenDepth(tokens) {
      ...
      for (var i4 = 0; i4 < tokens.length; i4++) {
        loop = loop || tokens[i4].type === "keyword" && tokens[i4].data === "for";
        switch (tokens[i4].data) {
          case "(":
            tokens[i4].depth = loop ? depth++ : depth;
            break;
          case "{":
            tokens[i4].depth = loop ? depth : depth++;
            loop = false;
...
var require_glsl_token_string = __commonJS({
  "node_modules/glsl-token-string/index.js"(exports, module) {
    ...
    function toString(tokens) {
      var output = [];
      for (var i4 = 0; i4 < tokens.length; i4++) {
        if (tokens[i4].type === "eof")
          continue;
        output.push(tokens[i4].data);
      }
      return output.join("");
    }
  }
...
var require_glsl_token_functions = __commonJS({
  "node_modules/glsl-token-functions/index.js"(exports, module) {
    ...
    function functions(tokens) {
      ...
      var output = [];
      var i4, j3, token;
      for (i4 = 0, j3; i4 < tokens.length; i4++) {
        token = tokens[i4];
        if (token.data === "{") {
          if (braceDepth && braceDepth++)
            continue;
          j3 = findPrevious(i4, findOp(")"), findOp());
          if (j3 < 0)
            continue;
          argFinish = j3;
          ...
          defnStart = j3;
          var k4 = findPrevious(j3, findGlyph);
          switch (tokens[k4] && tokens[k4].data) {
            case "lowp":
            case "highp":
            case "mediump":
              defnStart = k4;
          ...
          output.push({
            name: defnName,
            type: returnType,
            body: [braceStart + 1, i4],
            args: [argStart, argFinish + 1],
            outer: [defnStart, i4 + 1]
          });
        }
      }
      ...
      return output.sort(function(a4, b4) {
        return a4.outer[0] - b4.outer[0];
      });
      function findPrevious(start, match, bail) {
        for (var i5 = start - 1; i5 >= 0; i5--) {
          if (match(tokens[i5]))
            return i5;
          if (bail && bail(tokens[i5]))
            return -1;
        }
        return -1;
      }
...
var require_object_hash = __commonJS({
  "node_modules/object-hash/dist/object_hash.js"(exports, module) {
    !function(e4) {
      var t4;
      "object" == typeof exports ? module.exports = e4() : "function" == typeof define && define.amd ? define(e4) : ("undefined" != typeof window ? t4 = window : "undefined" != typeof global ? t4 = global : "undefined" != typeof self && (t4 = self), t4.objectHash = e4());
    }(function() {
      return function r4(o4, i4, u4) {
        function s4(n4, e5) {
          if (!i4[n4]) {
            if (!o4[n4]) {
              var t4 = "function" == typeof __require && __require;
              if (!e5 && t4)
                return t4(n4, true);
              if (a4)
                return a4(n4, true);
            ...
            e5 = i4[n4] = { exports: {} };
            o4[n4][0].call(e5.exports, function(e6) {
              var t5 = o4[n4][1][e6];
              return s4(t5 || e6);
            }, e5, e5.exports, r4, o4, i4, u4);
          }
          return i4[n4].exports;
        }
        for (var a4 = "function" == typeof __require && __require, e4 = 0; e4 < u4.length; e4++)
          s4(u4[e4]);
        return s4;
      }({ 1: [function(w3, b4, m4) {
        !(function(e4, n4, s4, c4, d4, h4, p4, g4, y4) {
          "use strict";
          var r4 = w3("crypto");
          function t4(e5, t5) {
            t5 = u4(e5, t5);
            var n5;
            return void 0 === (n5 = "passthrough" !== t5.algorithm ? r4.createHash(t5.algorithm) : new l4()).write && (n5.write = n5.update, n5.end = n5.update), f4(t5, n5).dispatch(e5), n5.update || n5.end(""), n5.digest ? n5.digest("buffer" === t5.encoding ? void 0 : t5.encoding) : (e5 = n5.read(), "buffer" !== t5.encoding ? e5.toString(t5.encoding) : e5);
          }
          (m4 = b4.exports = t4).sha1 = function(e5) {
            return t4(e5);
          }, m4.keys = function(e5) {
            return t4(e5, { excludeValues: true, algorithm: "sha1", encoding: "hex" });
          }, m4.MD5 = function(e5) {
            return t4(e5, { algorithm: "md5", encoding: "hex" });
          }, m4.keysMD5 = function(e5) {
            return t4(e5, { algorithm: "md5", encoding: "hex", excludeValues: true });
          };
          var o4 = r4.getHashes ? r4.getHashes().slice() : ["sha1", "md5"], i4 = (o4.push("passthrough"), ["buffer", "hex", "binary", "base64"]);
          function u4(e5, t5) {
            var n5 = {};
            if (n5.algorithm = (t5 = t5 || {}).algorithm || "sha1", n5.encoding = t5.encoding || "hex", n5.excludeValues = !!t5.excludeValues, n5.algorithm = n5.algorithm.toLowerCase(), n5.encoding = n5.encoding.toLowerCase(), n5.ignoreUnknown = true === t5.ignoreUnknown, n5.respectType = false !== t5.respectType, n5.respectFunctionNames = false !== t5.respectFunctionNames, n5.respectFunctionProperties = false !== t5.respectFunctionProperties, n5.unorderedArrays = true === t5.unorderedArrays, n5.unorderedSets = false !== t5.unorderedSets, n5.unorderedObjects = false !== t5.unorderedObjects, n5.replacer = t5.replacer || void 0, n5.excludeKeys = t5.excludeKeys || void 0, void 0 === e5)
              throw new Error("Object argument required.");
            for (var r5 = 0; r5 < o4.length; ++r5)
              o4[r5].toLowerCase() === n5.algorithm.toLowerCase() && (n5.algorithm = o4[r5]);
          ...
          function a4(e5) {
            if ("function" == typeof e5)
              return null != /^function\s+\w*\s*\(\s*\)\s*{\s+\[native code\]\s+}$/i.exec(Function.prototype.toString.call(e5));
          }
          function f4(o5, t5, i5) {
            i5 = i5 || [];
            function u5(e5) {
              return t5.update ? t5.update(e5, "utf8") : t5.write(e5, "utf8");
            }
            return { dispatch: function(e5) {
              return this["_" + (null === (e5 = o5.replacer ? o5.replacer(e5) : e5) ? "null" : typeof e5)](e5);
            }, _object: function(t6) {
              var n5, e5 = Object.prototype.toString.call(t6), r5 = /\[object (.*)\]/i.exec(e5);
              r5 = (r5 = r5 ? r5[1] : "unknown:[" + e5 + "]").toLowerCase();
              if (0 <= (e5 = i5.indexOf(t6)))
                return this.dispatch("[CIRCULAR:" + e5 + "]");
              if (i5.push(t6), void 0 !== s4 && s4.isBuffer && s4.isBuffer(t6))
                return u5("buffer:"), u5(t6);
              if ("object" === r5 || "function" === r5 || "asyncfunction" === r5)
                return e5 = Object.keys(t6), o5.unorderedObjects && (e5 = e5.sort()), false === o5.respectType || a4(t6) || e5.splice(0, 0, "prototype", "__proto__", "constructor"), o5.excludeKeys && (e5 = e5.filter(function(e6) {
                  return !o5.excludeKeys(e6);
                })), u5("object:" + e5.length + ":"), n5 = this, e5.forEach(function(e6) {
                  n5.dispatch(e6), u5(":"), o5.excludeValues || n5.dispatch(t6[e6]), u5(",");
                });
              if (!this["_" + r5]) {
                if (o5.ignoreUnknown)
                  return u5("[" + r5 + "]");
              ...
              this["_" + r5](t6);
            }, _array: function(e5, t6) {
              t6 = void 0 !== t6 ? t6 : false !== o5.unorderedArrays;
              var n5 = this;
              if (u5("array:" + e5.length + ":"), !t6 || e5.length <= 1)
                return e5.forEach(function(e6) {
                  return n5.dispatch(e6);
                });
              var r5 = [], t6 = e5.map(function(e6) {
                var t7 = new l4(), n6 = i5.slice();
                return f4(o5, t7, n6).dispatch(e6), r5 = r5.concat(n6.slice(i5.length)), t7.read().toString();
              });
              return i5 = i5.concat(r5), t6.sort(), this._array(t6, false);
            }, _date: function(e5) {
              return u5("date:" + e5.toJSON());
            }, _symbol: function(e5) {
              return u5("symbol:" + e5.toString());
            }, _error: function(e5) {
              return u5("error:" + e5.toString());
            }, _boolean: function(e5) {
              return u5("bool:" + e5.toString());
            }, _string: function(e5) {
              u5("string:" + e5.length + ":"), u5(e5.toString());
            }, _function: function(e5) {
              u5("fn:"), a4(e5) ? this.dispatch("[native]") : this.dispatch(e5.toString()), false !== o5.respectFunctionNames && this.dispatch("function-name:" + String(e5.name)), o5.respectFunctionProperties && this._object(e5);
            }, _number: function(e5) {
              return u5("number:" + e5.toString());
            }, _xml: function(e5) {
              return u5("xml:" + e5.toString());
            }, _null: function() {
              return u5("Null");
            }, _undefined: function() {
              return u5("Undefined");
            }, _regexp: function(e5) {
              return u5("regex:" + e5.toString());
            }, _uint8array: function(e5) {
              return u5("uint8array:"), this.dispatch(Array.prototype.slice.call(e5));
            }, _uint8clampedarray: function(e5) {
              return u5("uint8clampedarray:"), this.dispatch(Array.prototype.slice.call(e5));
            }, _int8array: function(e5) {
              return u5("int8array:"), this.dispatch(Array.prototype.slice.call(e5));
            }, _uint16array: function(e5) {
              return u5("uint16array:"), this.dispatch(Array.prototype.slice.call(e5));
            }, _int16array: function(e5) {
              return u5("int16array:"), this.dispatch(Array.prototype.slice.call(e5));
            }, _uint32array: function(e5) {
              return u5("uint32array:"), this.dispatch(Array.prototype.slice.call(e5));
            }, _int32array: function(e5) {
              return u5("int32array:"), this.dispatch(Array.prototype.slice.call(e5));
            }, _float32array: function(e5) {
              return u5("float32array:"), this.dispatch(Array.prototype.slice.call(e5));
            }, _float64array: function(e5) {
              return u5("float64array:"), this.dispatch(Array.prototype.slice.call(e5));
            }, _arraybuffer: function(e5) {
              return u5("arraybuffer:"), this.dispatch(new Uint8Array(e5));
            }, _url: function(e5) {
              return u5("url:" + e5.toString());
            }, _map: function(e5) {
              u5("map:");
              e5 = Array.from(e5);
              return this._array(e5, false !== o5.unorderedSets);
            }, _set: function(e5) {
              u5("set:");
              e5 = Array.from(e5);
              return this._array(e5, false !== o5.unorderedSets);
            }, _file: function(e5) {
              return u5("file:"), this.dispatch([e5.name, e5.size, e5.type, e5.lastModfied]);
            }, _blob: function() {
              if (o5.ignoreUnknown)
                return u5("[blob]");
          ...
          m4.writeToStream = function(e5, t5, n5) {
            return void 0 === n5 && (n5 = t5, t5 = {}), f4(t5 = u4(e5, t5), n5).dispatch(e5);
          };
      ...
      }, { buffer: 3, crypto: 5, lYpoI2: 11 }], 2: [function(e4, t4, f4) {
        !(function(e5, t5, n4, r4, o4, i4, u4, s4, a4) {
          !function(e6) {
            "use strict";
            var a5 = "undefined" != typeof Uint8Array ? Uint8Array : Array, t6 = "+".charCodeAt(0), n5 = "/".charCodeAt(0), r5 = "0".charCodeAt(0), o5 = "a".charCodeAt(0), i5 = "A".charCodeAt(0), u5 = "-".charCodeAt(0), s5 = "_".charCodeAt(0);
            function f5(e7) {
              e7 = e7.charCodeAt(0);
              return e7 === t6 || e7 === u5 ? 62 : e7 === n5 || e7 === s5 ? 63 : e7 < r5 ? -1 : e7 < r5 + 10 ? e7 - r5 + 26 + 26 : e7 < i5 + 26 ? e7 - i5 : e7 < o5 + 26 ? e7 - o5 + 26 : void 0;
            }
            e6.toByteArray = function(e7) {
              var t7, n6;
              if (0 < e7.length % 4)
                throw new Error("Invalid string. Length must be a multiple of 4");
              var r6 = e7.length, r6 = "=" === e7.charAt(r6 - 2) ? 2 : "=" === e7.charAt(r6 - 1) ? 1 : 0, o6 = new a5(3 * e7.length / 4 - r6), i6 = 0 < r6 ? e7.length - 4 : e7.length, u6 = 0;
              function s6(e8) {
                o6[u6++] = e8;
              }
              for (t7 = 0; t7 < i6; t7 += 4, 0)
                s6((16711680 & (n6 = f5(e7.charAt(t7)) << 18 | f5(e7.charAt(t7 + 1)) << 12 | f5(e7.charAt(t7 + 2)) << 6 | f5(e7.charAt(t7 + 3)))) >> 16), s6((65280 & n6) >> 8), s6(255 & n6);
              return 2 == r6 ? s6(255 & (n6 = f5(e7.charAt(t7)) << 2 | f5(e7.charAt(t7 + 1)) >> 4)) : 1 == r6 && (s6((n6 = f5(e7.charAt(t7)) << 10 | f5(e7.charAt(t7 + 1)) << 4 | f5(e7.charAt(t7 + 2)) >> 2) >> 8 & 255), s6(255 & n6)), o6;
            }, e6.fromByteArray = function(e7) {
              var t7, n6, r6, o6, i6 = e7.length % 3, u6 = "";
              function s6(e8) {
                return "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(e8);
              }
              for (t7 = 0, r6 = e7.length - i6; t7 < r6; t7 += 3)
                n6 = (e7[t7] << 16) + (e7[t7 + 1] << 8) + e7[t7 + 2], u6 += s6((o6 = n6) >> 18 & 63) + s6(o6 >> 12 & 63) + s6(o6 >> 6 & 63) + s6(63 & o6);
              switch (i6) {
                case 1:
                  u6 = (u6 += s6((n6 = e7[e7.length - 1]) >> 2)) + s6(n6 << 4 & 63) + "==";
                  break;
                case 2:
                  u6 = (u6 = (u6 += s6((n6 = (e7[e7.length - 2] << 8) + e7[e7.length - 1]) >> 10)) + s6(n6 >> 4 & 63)) + s6(n6 << 2 & 63) + "=";
              }
              return u6;
            };
          }(void 0 === f4 ? this.base64js = {} : f4);
        }).call(this, e4("lYpoI2"), "undefined" != typeof self ? self : "undefined" != typeof window ? window : {}, e4("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/node_modules/gulp-browserify/node_modules/base64-js/lib/b64.js", "/node_modules/gulp-browserify/node_modules/base64-js/lib");
      }, { buffer: 3, lYpoI2: 11 }], 3: [function(O2, e4, H3) {
        !(function(e5, n4, f4, r4, h4, p4, g4, y4, w3) {
          var a4 = O2("base64-js"), i4 = O2("ieee754");
          function f4(e6, t5, n5) {
            if (!(this instanceof f4))
              return new f4(e6, t5, n5);
            var r5, o5, i5, u5, s5 = typeof e6;
            if ("base64" === t5 && "string" == s5)
              for (e6 = (u5 = e6).trim ? u5.trim() : u5.replace(/^\s+|\s+$/g, ""); e6.length % 4 != 0; )
                e6 += "=";
            if ("number" == s5)
              r5 = j3(e6);
            else if ("string" == s5)
              r5 = f4.byteLength(e6, t5);
            else {
              if ("object" != s5)
                throw new Error("First argument needs to be a number, array or string.");
              r5 = j3(e6.length);
            }
            if (f4._useTypedArrays ? o5 = f4._augment(new Uint8Array(r5)) : ((o5 = this).length = r5, o5._isBuffer = true), f4._useTypedArrays && "number" == typeof e6.byteLength)
              o5._set(e6);
            else if (C2(u5 = e6) || f4.isBuffer(u5) || u5 && "object" == typeof u5 && "number" == typeof u5.length)
              for (i5 = 0; i5 < r5; i5++)
                f4.isBuffer(e6) ? o5[i5] = e6.readUInt8(i5) : o5[i5] = e6[i5];
            else if ("string" == s5)
              o5.write(e6, 0, t5);
          ...
          function b4(e6, t5, n5, r5) {
            return f4._charsWritten = c4(function(e7) {
              for (var t6 = [], n6 = 0; n6 < e7.length; n6++)
                t6.push(255 & e7.charCodeAt(n6));
              return t6;
            }(t5), e6, n5, r5);
          }
          function m4(e6, t5, n5, r5) {
            return f4._charsWritten = c4(function(e7) {
              for (var t6, n6, r6 = [], o5 = 0; o5 < e7.length; o5++)
                n6 = e7.charCodeAt(o5), t6 = n6 >> 8, n6 = n6 % 256, r6.push(n6), r6.push(t6);
              return r6;
            }(t5), e6, n5, r5);
          }
          function v4(e6, t5, n5) {
            var r5 = "";
            n5 = Math.min(e6.length, n5);
            for (var o5 = t5; o5 < n5; o5++)
              r5 += String.fromCharCode(e6[o5]);
            return r5;
          }
          function o4(e6, t5, n5, r5) {
            r5 || (d4("boolean" == typeof n5, "missing or invalid endian"), d4(null != t5, "missing offset"), d4(t5 + 1 < e6.length, "Trying to read beyond buffer length"));
            var o5, r5 = e6.length;
            if (!(r5 <= t5))
              return n5 ? (o5 = e6[t5], t5 + 1 < r5 && (o5 |= e6[t5 + 1] << 8)) : (o5 = e6[t5] << 8, t5 + 1 < r5 && (o5 |= e6[t5 + 1])), o5;
          }
          function u4(e6, t5, n5, r5) {
            r5 || (d4("boolean" == typeof n5, "missing or invalid endian"), d4(null != t5, "missing offset"), d4(t5 + 3 < e6.length, "Trying to read beyond buffer length"));
            var o5, r5 = e6.length;
            if (!(r5 <= t5))
              return n5 ? (t5 + 2 < r5 && (o5 = e6[t5 + 2] << 16), t5 + 1 < r5 && (o5 |= e6[t5 + 1] << 8), o5 |= e6[t5], t5 + 3 < r5 && (o5 += e6[t5 + 3] << 24 >>> 0)) : (t5 + 1 < r5 && (o5 = e6[t5 + 1] << 16), t5 + 2 < r5 && (o5 |= e6[t5 + 2] << 8), t5 + 3 < r5 && (o5 |= e6[t5 + 3]), o5 += e6[t5] << 24 >>> 0), o5;
          }
          function _2(e6, t5, n5, r5) {
            if (r5 || (d4("boolean" == typeof n5, "missing or invalid endian"), d4(null != t5, "missing offset"), d4(t5 + 1 < e6.length, "Trying to read beyond buffer length")), !(e6.length <= t5))
              return r5 = o4(e6, t5, n5, true), 32768 & r5 ? -1 * (65535 - r5 + 1) : r5;
          }
          function E2(e6, t5, n5, r5) {
            if (r5 || (d4("boolean" == typeof n5, "missing or invalid endian"), d4(null != t5, "missing offset"), d4(t5 + 3 < e6.length, "Trying to read beyond buffer length")), !(e6.length <= t5))
              return r5 = u4(e6, t5, n5, true), 2147483648 & r5 ? -1 * (4294967295 - r5 + 1) : r5;
          }
          function I4(e6, t5, n5, r5) {
            return r5 || (d4("boolean" == typeof n5, "missing or invalid endian"), d4(t5 + 3 < e6.length, "Trying to read beyond buffer length")), i4.read(e6, t5, n5, 23, 4);
          }
          function A2(e6, t5, n5, r5) {
            return r5 || (d4("boolean" == typeof n5, "missing or invalid endian"), d4(t5 + 7 < e6.length, "Trying to read beyond buffer length")), i4.read(e6, t5, n5, 52, 8);
          }
          function s4(e6, t5, n5, r5, o5) {
            o5 || (d4(null != t5, "missing value"), d4("boolean" == typeof r5, "missing or invalid endian"), d4(null != n5, "missing offset"), d4(n5 + 1 < e6.length, "trying to write beyond buffer length"), Y3(t5, 65535));
            o5 = e6.length;
            if (!(o5 <= n5))
              for (var i5 = 0, u5 = Math.min(o5 - n5, 2); i5 < u5; i5++)
                e6[n5 + i5] = (t5 & 255 << 8 * (r5 ? i5 : 1 - i5)) >>> 8 * (r5 ? i5 : 1 - i5);
          }
          function l4(e6, t5, n5, r5, o5) {
            o5 || (d4(null != t5, "missing value"), d4("boolean" == typeof r5, "missing or invalid endian"), d4(null != n5, "missing offset"), d4(n5 + 3 < e6.length, "trying to write beyond buffer length"), Y3(t5, 4294967295));
            o5 = e6.length;
            if (!(o5 <= n5))
              for (var i5 = 0, u5 = Math.min(o5 - n5, 4); i5 < u5; i5++)
                e6[n5 + i5] = t5 >>> 8 * (r5 ? i5 : 3 - i5) & 255;
          }
          function B2(e6, t5, n5, r5, o5) {
            o5 || (d4(null != t5, "missing value"), d4("boolean" == typeof r5, "missing or invalid endian"), d4(null != n5, "missing offset"), d4(n5 + 1 < e6.length, "Trying to write beyond buffer length"), F3(t5, 32767, -32768)), e6.length <= n5 || s4(e6, 0 <= t5 ? t5 : 65535 + t5 + 1, n5, r5, o5);
          }
          function L3(e6, t5, n5, r5, o5) {
            o5 || (d4(null != t5, "missing value"), d4("boolean" == typeof r5, "missing or invalid endian"), d4(null != n5, "missing offset"), d4(n5 + 3 < e6.length, "Trying to write beyond buffer length"), F3(t5, 2147483647, -2147483648)), e6.length <= n5 || l4(e6, 0 <= t5 ? t5 : 4294967295 + t5 + 1, n5, r5, o5);
          }
          function U3(e6, t5, n5, r5, o5) {
            o5 || (d4(null != t5, "missing value"), d4("boolean" == typeof r5, "missing or invalid endian"), d4(null != n5, "missing offset"), d4(n5 + 3 < e6.length, "Trying to write beyond buffer length"), D2(t5, 34028234663852886e22, -34028234663852886e22)), e6.length <= n5 || i4.write(e6, t5, n5, r5, 23, 4);
          }
          function x3(e6, t5, n5, r5, o5) {
            o5 || (d4(null != t5, "missing value"), d4("boolean" == typeof r5, "missing or invalid endian"), d4(null != n5, "missing offset"), d4(n5 + 7 < e6.length, "Trying to write beyond buffer length"), D2(t5, 17976931348623157e292, -17976931348623157e292)), e6.length <= n5 || i4.write(e6, t5, n5, r5, 52, 8);
          }
          H3.Buffer = f4, H3.SlowBuffer = f4, H3.INSPECT_MAX_BYTES = 50, f4.poolSize = 8192, f4._useTypedArrays = function() {
            try {
              var e6 = new ArrayBuffer(0), t5 = new Uint8Array(e6);
          ...
          }, f4.isBuffer = function(e6) {
            return !(null == e6 || !e6._isBuffer);
          }, f4.byteLength = function(e6, t5) {
            var n5;
            switch (e6 += "", t5 || "utf8") {
              case "hex":
                n5 = e6.length / 2;
            ...
            return n5;
          }, f4.concat = function(e6, t5) {
            if (d4(C2(e6), "Usage: Buffer.concat(list, [totalLength])\nlist should be an Array."), 0 === e6.length)
              return new f4(0);
            if (1 === e6.length)
              return e6[0];
            if ("number" != typeof t5)
              for (o5 = t5 = 0; o5 < e6.length; o5++)
                t5 += e6[o5].length;
            for (var n5 = new f4(t5), r5 = 0, o5 = 0; o5 < e6.length; o5++) {
              var i5 = e6[o5];
              i5.copy(n5, r5), r5 += i5.length;
            }
            return n5;
          }, f4.prototype.write = function(e6, t5, n5, r5) {
            isFinite(t5) ? isFinite(n5) || (r5 = n5, n5 = void 0) : (a5 = r5, r5 = t5, t5 = n5, n5 = a5), t5 = Number(t5) || 0;
            var o5, i5, u5, s5, a5 = this.length - t5;
            switch ((!n5 || a5 < (n5 = Number(n5))) && (n5 = a5), r5 = String(r5 || "utf8").toLowerCase()) {
              case "hex":
                o5 = function(e7, t6, n6, r6) {
                  n6 = Number(n6) || 0;
                  var o6 = e7.length - n6;
                  (!r6 || o6 < (r6 = Number(r6))) && (r6 = o6), d4((o6 = t6.length) % 2 == 0, "Invalid hex string"), o6 / 2 < r6 && (r6 = o6 / 2);
                  for (var i6 = 0; i6 < r6; i6++) {
                    var u6 = parseInt(t6.substr(2 * i6, 2), 16);
                    d4(!isNaN(u6), "Invalid hex string"), e7[n6 + i6] = u6;
                  }
              ...
              case "utf8":
              case "utf-8":
                i5 = this, u5 = t5, s5 = n5, o5 = f4._charsWritten = c4(T3(e6), i5, u5, s5);
                break;
              case "ascii":
              case "binary":
                o5 = b4(this, e6, t5, n5);
                break;
              case "base64":
                i5 = this, u5 = t5, s5 = n5, o5 = f4._charsWritten = c4(M3(e6), i5, u5, s5);
                break;
              case "ucs2":
              case "ucs-2":
              case "utf16le":
            ...
            return o5;
          }, f4.prototype.toString = function(e6, t5, n5) {
            var r5, o5, i5, u5, s5 = this;
            if (e6 = String(e6 || "utf8").toLowerCase(), t5 = Number(t5) || 0, (n5 = void 0 !== n5 ? Number(n5) : s5.length) === t5)
              return "";
            switch (e6) {
              case "hex":
                r5 = function(e7, t6, n6) {
                  var r6 = e7.length;
                  (!t6 || t6 < 0) && (t6 = 0);
                  (!n6 || n6 < 0 || r6 < n6) && (n6 = r6);
                  for (var o6 = "", i6 = t6; i6 < n6; i6++)
                    o6 += k4(e7[i6]);
                  return o6;
                }(s5, t5, n5);
                break;
              ...
              case "utf-8":
                r5 = function(e7, t6, n6) {
                  ...
                  for (var i6 = t6; i6 < n6; i6++)
                    e7[i6] <= 127 ? (r6 += N3(o6) + String.fromCharCode(e7[i6]), o6 = "") : o6 += "%" + e7[i6].toString(16);
                  return r6 + N3(o6);
                }(s5, t5, n5);
                break;
              case "ascii":
              case "binary":
                ...
                break;
              case "base64":
                o5 = s5, u5 = n5, r5 = 0 === (i5 = t5) && u5 === o5.length ? a4.fromByteArray(o5) : a4.fromByteArray(o5.slice(i5, u5));
                break;
              case "ucs2":
              case "ucs-2":
              case "utf16le":
              case "utf-16le":
                r5 = function(e7, t6, n6) {
                  for (var r6 = e7.slice(t6, n6), o6 = "", i6 = 0; i6 < r6.length; i6 += 2)
                    o6 += String.fromCharCode(r6[i6] + 256 * r6[i6 + 1]);
                  return o6;
                }(s5, t5, n5);
                break;
              default:
          ...
          }, f4.prototype.copy = function(e6, t5, n5, r5) {
            if (t5 = t5 || 0, (r5 = r5 || 0 === r5 ? r5 : this.length) !== (n5 = n5 || 0) && 0 !== e6.length && 0 !== this.length) {
              d4(n5 <= r5, "sourceEnd < sourceStart"), d4(0 <= t5 && t5 < e6.length, "targetStart out of bounds"), d4(0 <= n5 && n5 < this.length, "sourceStart out of bounds"), d4(0 <= r5 && r5 <= this.length, "sourceEnd out of bounds"), r5 > this.length && (r5 = this.length);
              var o5 = (r5 = e6.length - t5 < r5 - n5 ? e6.length - t5 + n5 : r5) - n5;
              if (o5 < 100 || !f4._useTypedArrays)
                for (var i5 = 0; i5 < o5; i5++)
                  e6[i5 + t5] = this[i5 + n5];
              else
                e6._set(this.subarray(n5, n5 + o5), t5);
            }
          }, f4.prototype.slice = function(e6, t5) {
            var n5 = this.length;
            if (e6 = S4(e6, n5, 0), t5 = S4(t5, n5, n5), f4._useTypedArrays)
              return f4._augment(this.subarray(e6, t5));
            for (var r5 = t5 - e6, o5 = new f4(r5, void 0, true), i5 = 0; i5 < r5; i5++)
              o5[i5] = this[i5 + e6];
            return o5;
          }, f4.prototype.get = function(e6) {
            return console.log(".get() is deprecated. Access using array indexes instead."), this.readUInt8(e6);
          }, f4.prototype.set = function(e6, t5) {
            return console.log(".set() is deprecated. Access using array indexes instead."), this.writeUInt8(e6, t5);
          }, f4.prototype.readUInt8 = function(e6, t5) {
            if (t5 || (d4(null != e6, "missing offset"), d4(e6 < this.length, "Trying to read beyond buffer length")), !(e6 >= this.length))
              return this[e6];
          }, f4.prototype.readUInt16LE = function(e6, t5) {
            return o4(this, e6, true, t5);
          }, f4.prototype.readUInt16BE = function(e6, t5) {
            return o4(this, e6, false, t5);
          }, f4.prototype.readUInt32LE = function(e6, t5) {
            return u4(this, e6, true, t5);
          }, f4.prototype.readUInt32BE = function(e6, t5) {
            return u4(this, e6, false, t5);
          }, f4.prototype.readInt8 = function(e6, t5) {
            if (t5 || (d4(null != e6, "missing offset"), d4(e6 < this.length, "Trying to read beyond buffer length")), !(e6 >= this.length))
              return 128 & this[e6] ? -1 * (255 - this[e6] + 1) : this[e6];
          }, f4.prototype.readInt16LE = function(e6, t5) {
            return _2(this, e6, true, t5);
          }, f4.prototype.readInt16BE = function(e6, t5) {
            return _2(this, e6, false, t5);
          }, f4.prototype.readInt32LE = function(e6, t5) {
            return E2(this, e6, true, t5);
          }, f4.prototype.readInt32BE = function(e6, t5) {
            return E2(this, e6, false, t5);
          }, f4.prototype.readFloatLE = function(e6, t5) {
            return I4(this, e6, true, t5);
          }, f4.prototype.readFloatBE = function(e6, t5) {
            return I4(this, e6, false, t5);
          }, f4.prototype.readDoubleLE = function(e6, t5) {
            return A2(this, e6, true, t5);
          }, f4.prototype.readDoubleBE = function(e6, t5) {
            return A2(this, e6, false, t5);
          }, f4.prototype.writeUInt8 = function(e6, t5, n5) {
            n5 || (d4(null != e6, "missing value"), d4(null != t5, "missing offset"), d4(t5 < this.length, "trying to write beyond buffer length"), Y3(e6, 255)), t5 >= this.length || (this[t5] = e6);
          }, f4.prototype.writeUInt16LE = function(e6, t5, n5) {
            s4(this, e6, t5, true, n5);
          }, f4.prototype.writeUInt16BE = function(e6, t5, n5) {
            s4(this, e6, t5, false, n5);
          }, f4.prototype.writeUInt32LE = function(e6, t5, n5) {
            l4(this, e6, t5, true, n5);
          }, f4.prototype.writeUInt32BE = function(e6, t5, n5) {
            l4(this, e6, t5, false, n5);
          }, f4.prototype.writeInt8 = function(e6, t5, n5) {
            n5 || (d4(null != e6, "missing value"), d4(null != t5, "missing offset"), d4(t5 < this.length, "Trying to write beyond buffer length"), F3(e6, 127, -128)), t5 >= this.length || (0 <= e6 ? this.writeUInt8(e6, t5, n5) : this.writeUInt8(255 + e6 + 1, t5, n5));
          }, f4.prototype.writeInt16LE = function(e6, t5, n5) {
            B2(this, e6, t5, true, n5);
          }, f4.prototype.writeInt16BE = function(e6, t5, n5) {
            B2(this, e6, t5, false, n5);
          }, f4.prototype.writeInt32LE = function(e6, t5, n5) {
            L3(this, e6, t5, true, n5);
          }, f4.prototype.writeInt32BE = function(e6, t5, n5) {
            L3(this, e6, t5, false, n5);
          }, f4.prototype.writeFloatLE = function(e6, t5, n5) {
            U3(this, e6, t5, true, n5);
          }, f4.prototype.writeFloatBE = function(e6, t5, n5) {
            U3(this, e6, t5, false, n5);
          }, f4.prototype.writeDoubleLE = function(e6, t5, n5) {
            x3(this, e6, t5, true, n5);
          }, f4.prototype.writeDoubleBE = function(e6, t5, n5) {
            x3(this, e6, t5, false, n5);
          }, f4.prototype.fill = function(e6, t5, n5) {
            if (t5 = t5 || 0, n5 = n5 || this.length, d4("number" == typeof (e6 = "string" == typeof (e6 = e6 || 0) ? e6.charCodeAt(0) : e6) && !isNaN(e6), "value is not a number"), d4(t5 <= n5, "end < start"), n5 !== t5 && 0 !== this.length) {
              d4(0 <= t5 && t5 < this.length, "start out of bounds"), d4(0 <= n5 && n5 <= this.length, "end out of bounds");
              for (var r5 = t5; r5 < n5; r5++)
                this[r5] = e6;
            }
          }, f4.prototype.inspect = function() {
            for (var e6 = [], t5 = this.length, n5 = 0; n5 < t5; n5++)
              if (e6[n5] = k4(this[n5]), n5 === H3.INSPECT_MAX_BYTES) {
                e6[n5 + 1] = "...";
                break;
              }
            ...
            for (var e6 = new Uint8Array(this.length), t5 = 0, n5 = e6.length; t5 < n5; t5 += 1)
              e6[t5] = this[t5];
            return e6.buffer;
          };
          var t4 = f4.prototype;
          function S4(e6, t5, n5) {
            return "number" != typeof e6 ? n5 : t5 <= (e6 = ~~e6) ? t5 : 0 <= e6 || 0 <= (e6 += t5) ? e6 : 0;
          }
          function j3(e6) {
          ...
          function C2(e6) {
            return (Array.isArray || function(e7) {
              return "[object Array]" === Object.prototype.toString.call(e7);
            })(e6);
          }
          function k4(e6) {
          ...
          function T3(e6) {
            for (var t5 = [], n5 = 0; n5 < e6.length; n5++) {
              var r5 = e6.charCodeAt(n5);
              if (r5 <= 127)
                t5.push(e6.charCodeAt(n5));
              else
                for (var o5 = n5, i5 = (55296 <= r5 && r5 <= 57343 && n5++, encodeURIComponent(e6.slice(o5, n5 + 1)).substr(1).split("%")), u5 = 0; u5 < i5.length; u5++)
                  t5.push(parseInt(i5[u5], 16));
            }
            return t5;
          }
          function M3(e6) {
            return a4.toByteArray(e6);
          }
          function c4(e6, t5, n5, r5) {
            for (var o5 = 0; o5 < r5 && !(o5 + n5 >= t5.length || o5 >= e6.length); o5++)
              t5[o5 + n5] = e6[o5];
            return o5;
          }
          function N3(e6) {
          ...
          function Y3(e6, t5) {
            d4("number" == typeof e6, "cannot write a non-number as a number"), d4(0 <= e6, "specified a negative value for writing an unsigned value"), d4(e6 <= t5, "value is larger than maximum value for type"), d4(Math.floor(e6) === e6, "value has a fractional component");
          }
          function F3(e6, t5, n5) {
            d4("number" == typeof e6, "cannot write a non-number as a number"), d4(e6 <= t5, "value larger than maximum allowed value"), d4(n5 <= e6, "value smaller than minimum allowed value"), d4(Math.floor(e6) === e6, "value has a fractional component");
          }
          function D2(e6, t5, n5) {
            d4("number" == typeof e6, "cannot write a non-number as a number"), d4(e6 <= t5, "value larger than maximum allowed value"), d4(n5 <= e6, "value smaller than minimum allowed value");
          }
          function d4(e6, t5) {
            if (!e6)
              throw new Error(t5 || "Failed assertion");
          }
          f4._augment = function(e6) {
            return e6._isBuffer = true, e6._get = e6.get, e6._set = e6.set, e6.get = t4.get, e6.set = t4.set, e6.write = t4.write, e6.toString = t4.toString, e6.toLocaleString = t4.toString, e6.toJSON = t4.toJSON, e6.copy = t4.copy, e6.slice = t4.slice, e6.readUInt8 = t4.readUInt8, e6.readUInt16LE = t4.readUInt16LE, e6.readUInt16BE = t4.readUInt16BE, e6.readUInt32LE = t4.readUInt32LE, e6.readUInt32BE = t4.readUInt32BE, e6.readInt8 = t4.readInt8, e6.readInt16LE = t4.readInt16LE, e6.readInt16BE = t4.readInt16BE, e6.readInt32LE = t4.readInt32LE, e6.readInt32BE = t4.readInt32BE, e6.readFloatLE = t4.readFloatLE, e6.readFloatBE = t4.readFloatBE, e6.readDoubleLE = t4.readDoubleLE, e6.readDoubleBE = t4.readDoubleBE, e6.writeUInt8 = t4.writeUInt8, e6.writeUInt16LE = t4.writeUInt16LE, e6.writeUInt16BE = t4.writeUInt16BE, e6.writeUInt32LE = t4.writeUInt32LE, e6.writeUInt32BE = t4.writeUInt32BE, e6.writeInt8 = t4.writeInt8, e6.writeInt16LE = t4.writeInt16LE, e6.writeInt16BE = t4.writeInt16BE, e6.writeInt32LE = t4.writeInt32LE, e6.writeInt32BE = t4.writeInt32BE, e6.writeFloatLE = t4.writeFloatLE, e6.writeFloatBE = t4.writeFloatBE, e6.writeDoubleLE = t4.writeDoubleLE, e6.writeDoubleBE = t4.writeDoubleBE, e6.fill = t4.fill, e6.inspect = t4.inspect, e6.toArrayBuffer = t4.toArrayBuffer, e6;
          };
      ...
      }, { "base64-js": 2, buffer: 3, ieee754: 10, lYpoI2: 11 }], 4: [function(c4, d4, e4) {
        !(function(e5, t4, a4, n4, r4, o4, i4, u4, s4) {
          var a4 = c4("buffer").Buffer, f4 = 4, l4 = new a4(f4);
          l4.fill(0);
          d4.exports = { hash: function(e6, t5, n5, r5) {
            for (var o5 = t5(function(e7, t6) {
              e7.length % f4 != 0 && (n6 = e7.length + (f4 - e7.length % f4), e7 = a4.concat([e7, l4], n6));
              for (var n6, r6 = [], o6 = t6 ? e7.readInt32BE : e7.readInt32LE, i6 = 0; i6 < e7.length; i6 += f4)
                r6.push(o6.call(e7, i6));
              return r6;
            }(e6 = a4.isBuffer(e6) ? e6 : new a4(e6), r5), 8 * e6.length), t5 = r5, i5 = new a4(n5), u5 = t5 ? i5.writeInt32BE : i5.writeInt32LE, s5 = 0; s5 < o5.length; s5++)
      ...
      }, { buffer: 3, lYpoI2: 11 }], 5: [function(v4, e4, _2) {
        !(function(l4, c4, u4, d4, h4, p4, g4, y4, w3) {
          var u4 = v4("buffer").Buffer, e5 = v4("./sha"), t4 = v4("./sha256"), n4 = v4("./rng"), b4 = { sha1: e5, sha256: t4, md5: v4("./md5") }, s4 = 64, a4 = new u4(s4);
          function r4(e6, n5) {
            var r5 = b4[e6 = e6 || "sha1"], o5 = [];
            return r5 || i4("algorithm:", e6, "is not yet supported"), { update: function(e7) {
              return u4.isBuffer(e7) || (e7 = new u4(e7)), o5.push(e7), e7.length, this;
            }, digest: function(e7) {
              var t5 = u4.concat(o5), t5 = n5 ? function(e8, t6, n6) {
                u4.isBuffer(t6) || (t6 = new u4(t6)), u4.isBuffer(n6) || (n6 = new u4(n6)), t6.length > s4 ? t6 = e8(t6) : t6.length < s4 && (t6 = u4.concat([t6, a4], s4));
                for (var r6 = new u4(s4), o6 = new u4(s4), i5 = 0; i5 < s4; i5++)
                  r6[i5] = 54 ^ t6[i5], o6[i5] = 92 ^ t6[i5];
                return n6 = e8(u4.concat([r6, n6])), e8(u4.concat([o6, n6]));
              }(r5, n5, t5) : r5(t5);
              return o5 = null, e7 ? t5.toString(e7) : t5;
            } };
          }
          function i4() {
          ...
          a4.fill(0), _2.createHash = function(e6) {
            return r4(e6);
          }, _2.createHmac = r4, _2.randomBytes = function(e6, t5) {
            if (!t5 || !t5.call)
              return new u4(n4(e6));
            try {
              t5.call(this, void 0, new u4(n4(e6)));
            } catch (e7) {
              t5(e7);
            }
          };
          var o4, f4 = ["createCredentials", "createCipher", "createCipheriv", "createDecipher", "createDecipheriv", "createSign", "createVerify", "createDiffieHellman", "pbkdf2"], m4 = function(e6) {
            _2[e6] = function() {
              i4("sorry,", e6, "is not implemented yet");
            };
          };
          for (o4 in f4)
            m4(f4[o4], o4);
      ...
      }, { "./md5": 6, "./rng": 7, "./sha": 8, "./sha256": 9, buffer: 3, lYpoI2: 11 }], 6: [function(w3, b4, e4) {
        !(function(e5, r4, o4, i4, u4, a4, f4, l4, y4) {
          var t4 = w3("./helpers");
          function n4(e6, t5) {
            e6[t5 >> 5] |= 128 << t5 % 32, e6[14 + (t5 + 64 >>> 9 << 4)] = t5;
            for (var n5 = 1732584193, r5 = -271733879, o5 = -1732584194, i5 = 271733878, u5 = 0; u5 < e6.length; u5 += 16) {
              var s5 = n5, a5 = r5, f5 = o5, l5 = i5, n5 = c4(n5, r5, o5, i5, e6[u5 + 0], 7, -680876936), i5 = c4(i5, n5, r5, o5, e6[u5 + 1], 12, -389564586), o5 = c4(o5, i5, n5, r5, e6[u5 + 2], 17, 606105819), r5 = c4(r5, o5, i5, n5, e6[u5 + 3], 22, -1044525330);
              n5 = c4(n5, r5, o5, i5, e6[u5 + 4], 7, -176418897), i5 = c4(i5, n5, r5, o5, e6[u5 + 5], 12, 1200080426), o5 = c4(o5, i5, n5, r5, e6[u5 + 6], 17, -1473231341), r5 = c4(r5, o5, i5, n5, e6[u5 + 7], 22, -45705983), n5 = c4(n5, r5, o5, i5, e6[u5 + 8], 7, 1770035416), i5 = c4(i5, n5, r5, o5, e6[u5 + 9], 12, -1958414417), o5 = c4(o5, i5, n5, r5, e6[u5 + 10], 17, -42063), r5 = c4(r5, o5, i5, n5, e6[u5 + 11], 22, -1990404162), n5 = c4(n5, r5, o5, i5, e6[u5 + 12], 7, 1804603682), i5 = c4(i5, n5, r5, o5, e6[u5 + 13], 12, -40341101), o5 = c4(o5, i5, n5, r5, e6[u5 + 14], 17, -1502002290), n5 = d4(n5, r5 = c4(r5, o5, i5, n5, e6[u5 + 15], 22, 1236535329), o5, i5, e6[u5 + 1], 5, -165796510), i5 = d4(i5, n5, r5, o5, e6[u5 + 6], 9, -1069501632), o5 = d4(o5, i5, n5, r5, e6[u5 + 11], 14, 643717713), r5 = d4(r5, o5, i5, n5, e6[u5 + 0], 20, -373897302), n5 = d4(n5, r5, o5, i5, e6[u5 + 5], 5, -701558691), i5 = d4(i5, n5, r5, o5, e6[u5 + 10], 9, 38016083), o5 = d4(o5, i5, n5, r5, e6[u5 + 15], 14, -660478335), r5 = d4(r5, o5, i5, n5, e6[u5 + 4], 20, -405537848), n5 = d4(n5, r5, o5, i5, e6[u5 + 9], 5, 568446438), i5 = d4(i5, n5, r5, o5, e6[u5 + 14], 9, -1019803690), o5 = d4(o5, i5, n5, r5, e6[u5 + 3], 14, -187363961), r5 = d4(r5, o5, i5, n5, e6[u5 + 8], 20, 1163531501), n5 = d4(n5, r5, o5, i5, e6[u5 + 13], 5, -1444681467), i5 = d4(i5, n5, r5, o5, e6[u5 + 2], 9, -51403784), o5 = d4(o5, i5, n5, r5, e6[u5 + 7], 14, 1735328473), n5 = h4(n5, r5 = d4(r5, o5, i5, n5, e6[u5 + 12], 20, -1926607734), o5, i5, e6[u5 + 5], 4, -378558), i5 = h4(i5, n5, r5, o5, e6[u5 + 8], 11, -2022574463), o5 = h4(o5, i5, n5, r5, e6[u5 + 11], 16, 1839030562), r5 = h4(r5, o5, i5, n5, e6[u5 + 14], 23, -35309556), n5 = h4(n5, r5, o5, i5, e6[u5 + 1], 4, -1530992060), i5 = h4(i5, n5, r5, o5, e6[u5 + 4], 11, 1272893353), o5 = h4(o5, i5, n5, r5, e6[u5 + 7], 16, -155497632), r5 = h4(r5, o5, i5, n5, e6[u5 + 10], 23, -1094730640), n5 = h4(n5, r5, o5, i5, e6[u5 + 13], 4, 681279174), i5 = h4(i5, n5, r5, o5, e6[u5 + 0], 11, -358537222), o5 = h4(o5, i5, n5, r5, e6[u5 + 3], 16, -722521979), r5 = h4(r5, o5, i5, n5, e6[u5 + 6], 23, 76029189), n5 = h4(n5, r5, o5, i5, e6[u5 + 9], 4, -640364487), i5 = h4(i5, n5, r5, o5, e6[u5 + 12], 11, -421815835), o5 = h4(o5, i5, n5, r5, e6[u5 + 15], 16, 530742520), n5 = p4(n5, r5 = h4(r5, o5, i5, n5, e6[u5 + 2], 23, -995338651), o5, i5, e6[u5 + 0], 6, -198630844), i5 = p4(i5, n5, r5, o5, e6[u5 + 7], 10, 1126891415), o5 = p4(o5, i5, n5, r5, e6[u5 + 14], 15, -1416354905), r5 = p4(r5, o5, i5, n5, e6[u5 + 5], 21, -57434055), n5 = p4(n5, r5, o5, i5, e6[u5 + 12], 6, 1700485571), i5 = p4(i5, n5, r5, o5, e6[u5 + 3], 10, -1894986606), o5 = p4(o5, i5, n5, r5, e6[u5 + 10], 15, -1051523), r5 = p4(r5, o5, i5, n5, e6[u5 + 1], 21, -2054922799), n5 = p4(n5, r5, o5, i5, e6[u5 + 8], 6, 1873313359), i5 = p4(i5, n5, r5, o5, e6[u5 + 15], 10, -30611744), o5 = p4(o5, i5, n5, r5, e6[u5 + 6], 15, -1560198380), r5 = p4(r5, o5, i5, n5, e6[u5 + 13], 21, 1309151649), n5 = p4(n5, r5, o5, i5, e6[u5 + 4], 6, -145523070), i5 = p4(i5, n5, r5, o5, e6[u5 + 11], 10, -1120210379), o5 = p4(o5, i5, n5, r5, e6[u5 + 2], 15, 718787259), r5 = p4(r5, o5, i5, n5, e6[u5 + 9], 21, -343485551), n5 = g4(n5, s5), r5 = g4(r5, a5), o5 = g4(o5, f5), i5 = g4(i5, l5);
            }
            return Array(n5, r5, o5, i5);
          }
          function s4(e6, t5, n5, r5, o5, i5) {
            return g4((t5 = g4(g4(t5, e6), g4(r5, i5))) << o5 | t5 >>> 32 - o5, n5);
          }
          function c4(e6, t5, n5, r5, o5, i5, u5) {
            return s4(t5 & n5 | ~t5 & r5, e6, t5, o5, i5, u5);
          }
          function d4(e6, t5, n5, r5, o5, i5, u5) {
            return s4(t5 & r5 | n5 & ~r5, e6, t5, o5, i5, u5);
          }
          function h4(e6, t5, n5, r5, o5, i5, u5) {
            return s4(t5 ^ n5 ^ r5, e6, t5, o5, i5, u5);
          }
          function p4(e6, t5, n5, r5, o5, i5, u5) {
            return s4(n5 ^ (t5 | ~r5), e6, t5, o5, i5, u5);
          }
          function g4(e6, t5) {
            var n5 = (65535 & e6) + (65535 & t5);
            return (e6 >> 16) + (t5 >> 16) + (n5 >> 16) << 16 | 65535 & n5;
          }
          b4.exports = function(e6) {
            return t4.hash(e6, n4, 16);
          };
      ...
      }, { "./helpers": 4, buffer: 3, lYpoI2: 11 }], 7: [function(e4, l4, t4) {
        !(function(e5, t5, n4, r4, o4, i4, u4, s4, f4) {
          var a4;
          l4.exports = a4 || function(e6) {
            for (var t6, n5 = new Array(e6), r5 = 0; r5 < e6; r5++)
              0 == (3 & r5) && (t6 = 4294967296 * Math.random()), n5[r5] = t6 >>> ((3 & r5) << 3) & 255;
            return n5;
          };
        }).call(this, e4("lYpoI2"), "undefined" != typeof self ? self : "undefined" != typeof window ? window : {}, e4("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/node_modules/gulp-browserify/node_modules/crypto-browserify/rng.js", "/node_modules/gulp-browserify/node_modules/crypto-browserify");
      }, { buffer: 3, lYpoI2: 11 }], 8: [function(c4, d4, e4) {
        !(function(e5, t4, n4, r4, o4, s4, a4, f4, l4) {
          var i4 = c4("./helpers");
          function u4(l5, c5) {
            l5[c5 >> 5] |= 128 << 24 - c5 % 32, l5[15 + (c5 + 64 >> 9 << 4)] = c5;
            for (var e6, t5, n5, r5 = Array(80), o5 = 1732584193, i5 = -271733879, u5 = -1732584194, s5 = 271733878, d5 = -1009589776, h4 = 0; h4 < l5.length; h4 += 16) {
              for (var p4 = o5, g4 = i5, y4 = u5, w3 = s5, b4 = d5, a5 = 0; a5 < 80; a5++) {
                r5[a5] = a5 < 16 ? l5[h4 + a5] : v4(r5[a5 - 3] ^ r5[a5 - 8] ^ r5[a5 - 14] ^ r5[a5 - 16], 1);
                var f5 = m4(m4(v4(o5, 5), (f5 = i5, t5 = u5, n5 = s5, (e6 = a5) < 20 ? f5 & t5 | ~f5 & n5 : !(e6 < 40) && e6 < 60 ? f5 & t5 | f5 & n5 | t5 & n5 : f5 ^ t5 ^ n5)), m4(m4(d5, r5[a5]), (e6 = a5) < 20 ? 1518500249 : e6 < 40 ? 1859775393 : e6 < 60 ? -1894007588 : -899497514)), d5 = s5, s5 = u5, u5 = v4(i5, 30), i5 = o5, o5 = f5;
              }
              o5 = m4(o5, p4), i5 = m4(i5, g4), u5 = m4(u5, y4), s5 = m4(s5, w3), d5 = m4(d5, b4);
            }
          ...
          d4.exports = function(e6) {
            return i4.hash(e6, u4, 20, true);
          };
      ...
      }, { "./helpers": 4, buffer: 3, lYpoI2: 11 }], 9: [function(c4, d4, e4) {
        !(function(e5, t4, n4, r4, u4, s4, a4, f4, l4) {
          function b4(e6, t5) {
            var n5 = (65535 & e6) + (65535 & t5);
            return (e6 >> 16) + (t5 >> 16) + (n5 >> 16) << 16 | 65535 & n5;
          }
          function o4(e6, l5) {
            var c5, d5 = new Array(1116352408, 1899447441, 3049323471, 3921009573, 961987163, 1508970993, 2453635748, 2870763221, 3624381080, 310598401, 607225278, 1426881987, 1925078388, 2162078206, 2614888103, 3248222580, 3835390401, 4022224774, 264347078, 604807628, 770255983, 1249150122, 1555081692, 1996064986, 2554220882, 2821834349, 2952996808, 3210313671, 3336571891, 3584528711, 113926993, 338241895, 666307205, 773529912, 1294757372, 1396182291, 1695183700, 1986661051, 2177026350, 2456956037, 2730485921, 2820302411, 3259730800, 3345764771, 3516065817, 3600352804, 4094571909, 275423344, 430227734, 506948616, 659060556, 883997877, 958139571, 1322822218, 1537002063, 1747873779, 1955562222, 2024104815, 2227730452, 2361852424, 2428436474, 2756734187, 3204031479, 3329325298), t5 = new Array(1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225), n5 = new Array(64);
            e6[l5 >> 5] |= 128 << 24 - l5 % 32, e6[15 + (l5 + 64 >> 9 << 4)] = l5;
            for (var r5, o5, h4 = 0; h4 < e6.length; h4 += 16) {
              for (var i5 = t5[0], u5 = t5[1], s5 = t5[2], p4 = t5[3], a5 = t5[4], g4 = t5[5], y4 = t5[6], w3 = t5[7], f5 = 0; f5 < 64; f5++)
                n5[f5] = f5 < 16 ? e6[f5 + h4] : b4(b4(b4((o5 = n5[f5 - 2], m4(o5, 17) ^ m4(o5, 19) ^ v4(o5, 10)), n5[f5 - 7]), (o5 = n5[f5 - 15], m4(o5, 7) ^ m4(o5, 18) ^ v4(o5, 3))), n5[f5 - 16]), c5 = b4(b4(b4(b4(w3, m4(o5 = a5, 6) ^ m4(o5, 11) ^ m4(o5, 25)), a5 & g4 ^ ~a5 & y4), d5[f5]), n5[f5]), r5 = b4(m4(r5 = i5, 2) ^ m4(r5, 13) ^ m4(r5, 22), i5 & u5 ^ i5 & s5 ^ u5 & s5), w3 = y4, y4 = g4, g4 = a5, a5 = b4(p4, c5), p4 = s5, s5 = u5, u5 = i5, i5 = b4(c5, r5);
              t5[0] = b4(i5, t5[0]), t5[1] = b4(u5, t5[1]), t5[2] = b4(s5, t5[2]), t5[3] = b4(p4, t5[3]), t5[4] = b4(a5, t5[4]), t5[5] = b4(g4, t5[5]), t5[6] = b4(y4, t5[6]), t5[7] = b4(w3, t5[7]);
            }
            return t5;
          }
          var i4 = c4("./helpers"), m4 = function(e6, t5) {
            return e6 >>> t5 | e6 << 32 - t5;
          }, v4 = function(e6, t5) {
            return e6 >>> t5;
          };
          d4.exports = function(e6) {
            return i4.hash(e6, o4, 32, true);
          };
      ...
      }, { "./helpers": 4, buffer: 3, lYpoI2: 11 }], 10: [function(e4, t4, f4) {
        !(function(e5, t5, n4, r4, o4, i4, u4, s4, a4) {
          f4.read = function(e6, t6, n5, r5, o5) {
            var i5, u5, l4 = 8 * o5 - r5 - 1, c4 = (1 << l4) - 1, d4 = c4 >> 1, s5 = -7, a5 = n5 ? o5 - 1 : 0, f5 = n5 ? -1 : 1, o5 = e6[t6 + a5];
            for (a5 += f5, i5 = o5 & (1 << -s5) - 1, o5 >>= -s5, s5 += l4; 0 < s5; i5 = 256 * i5 + e6[t6 + a5], a5 += f5, s5 -= 8)
              ;
            for (u5 = i5 & (1 << -s5) - 1, i5 >>= -s5, s5 += r5; 0 < s5; u5 = 256 * u5 + e6[t6 + a5], a5 += f5, s5 -= 8)
              ;
            if (0 === i5)
              i5 = 1 - d4;
            else {
              ...
              u5 += Math.pow(2, r5), i5 -= d4;
            }
            return (o5 ? -1 : 1) * u5 * Math.pow(2, i5 - r5);
          }, f4.write = function(e6, t6, l4, n5, r5, c4) {
            var o5, i5, u5 = 8 * c4 - r5 - 1, s5 = (1 << u5) - 1, a5 = s5 >> 1, d4 = 23 === r5 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, f5 = n5 ? 0 : c4 - 1, h4 = n5 ? 1 : -1, c4 = t6 < 0 || 0 === t6 && 1 / t6 < 0 ? 1 : 0;
            for (t6 = Math.abs(t6), isNaN(t6) || t6 === 1 / 0 ? (i5 = isNaN(t6) ? 1 : 0, o5 = s5) : (o5 = Math.floor(Math.log(t6) / Math.LN2), t6 * (n5 = Math.pow(2, -o5)) < 1 && (o5--, n5 *= 2), 2 <= (t6 += 1 <= o5 + a5 ? d4 / n5 : d4 * Math.pow(2, 1 - a5)) * n5 && (o5++, n5 /= 2), s5 <= o5 + a5 ? (i5 = 0, o5 = s5) : 1 <= o5 + a5 ? (i5 = (t6 * n5 - 1) * Math.pow(2, r5), o5 += a5) : (i5 = t6 * Math.pow(2, a5 - 1) * Math.pow(2, r5), o5 = 0)); 8 <= r5; e6[l4 + f5] = 255 & i5, f5 += h4, i5 /= 256, r5 -= 8)
              ;
            for (o5 = o5 << r5 | i5, u5 += r5; 0 < u5; e6[l4 + f5] = 255 & o5, f5 += h4, o5 /= 256, u5 -= 8)
              ;
            e6[l4 + f5 - h4] |= 128 * c4;
          };
        }).call(this, e4("lYpoI2"), "undefined" != typeof self ? self : "undefined" != typeof window ? window : {}, e4("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/node_modules/gulp-browserify/node_modules/ieee754/index.js", "/node_modules/gulp-browserify/node_modules/ieee754");
      }, { buffer: 3, lYpoI2: 11 }], 11: [function(e4, h4, t4) {
        !(function(e5, t5, n4, r4, o4, f4, l4, c4, d4) {
          var i4, u4, s4;
          function a4() {
          }
          (e5 = h4.exports = {}).nextTick = (u4 = "undefined" != typeof window && window.setImmediate, s4 = "undefined" != typeof window && window.postMessage && window.addEventListener, u4 ? function(e6) {
            return window.setImmediate(e6);
          } : s4 ? (i4 = [], window.addEventListener("message", function(e6) {
            var t6 = e6.source;
            t6 !== window && null !== t6 || "process-tick" !== e6.data || (e6.stopPropagation(), 0 < i4.length && i4.shift()());
          }, true), function(e6) {
            i4.push(e6), window.postMessage("process-tick", "*");
          }) : function(e6) {
            setTimeout(e6, 0);
          }), e5.title = "browser", e5.browser = true, e5.env = {}, e5.argv = [], e5.on = a4, e5.addListener = a4, e5.once = a4, e5.off = a4, e5.removeListener = a4, e5.removeAllListeners = a4, e5.emit = a4, e5.binding = function(e6) {
        ...
        }).call(this, e4("lYpoI2"), "undefined" != typeof self ? self : "undefined" != typeof window ? window : {}, e4("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/node_modules/gulp-browserify/node_modules/process/browser.js", "/node_modules/gulp-browserify/node_modules/process");
...
var require_extend_shallow2 = __commonJS({
  "node_modules/extend-shallow/index.js"(exports, module) {
    ...
    module.exports = function extend2(o4) {
      if (!isObject3(o4)) {
        o4 = {};
      }
...
var escapeRegExpMatch = function(s4) {
  return s4.replace(/[-\/\\^$*+?.()|[\]{}]/g, "\\$&");
};
var isExactMatch = (str, match) => {
  return new RegExp(`\\b${escapeRegExpMatch(match)}\\b`).test(str);
};
function isConstructor(f4) {
  try {
    new f4();
  } catch (err) {
...
`;
  ...
  parseShader(shader) {
    if (!shader)
      return;
    const s4 = shader.replace(/\/\*\*(.*?)\*\/|\/\/(.*?)\n/gm, "");
    const tokens = (0, import_glsl_tokenizer.default)(s4);
    const funcs = (0, import_glsl_token_functions.default)(tokens);
    const mainIndex = funcs.map((e4) => {
      return e4.name;
    }).indexOf("main");
...
function $c512c27ab02ef895$export$50c7b4e9d9f19c1(scopeName, createContextScopeDeps = []) {
  ...
  function $c512c27ab02ef895$export$fd42f52fd3ae1109(rootComponentName, defaultContext) {
    ...
    function Provider(props3) {
      ...
      const Context3 = (scope === null || scope === void 0 ? void 0 : scope[scopeName][index]) || BaseContext;
...
function NumberInput(_ref2) {
  ...
  const _onUpdate = (0, import_react18.useCallback)((v4) => onUpdate(parseNumber(v4)), [onUpdate]);
...
function useInputSetters({
  ...
  const setFormat = (0, import_react18.useCallback)((v4) => setDisplayValue(format$2(type, v4, settingsRef.current)), [type]);
...
function Select({
  ...
  return import_react18.default.createElement(SelectContainer, null, import_react18.default.createElement(NativeSelect, {
    ...
    disabled
  }, keys.map((key, index) => import_react18.default.createElement("option", {
    key,
    value: index
...
function Vector({
  ...
  }), Object.keys(value).map((key, i4) => import_react18.default.createElement(Coordinate, {
    id: i4 === 0 ? id : `${id}.${key}`,
    key,
    valueKey: key,
    value,
...
function i3(e4) {
  var t4 = (0, import_react21.useRef)(e4), n4 = (0, import_react21.useRef)(function(e5) {
...
var m3 = import_react21.default.memo(function(o4) {
  var a4 = o4.onMove, l4 = o4.onKey, s4 = c3(o4, ["onMove", "onKey"]), m4 = (0, import_react21.useRef)(null), g4 = i3(a4), p4 = i3(l4), b4 = (0, import_react21.useRef)(null), _2 = (0, import_react21.useRef)(false), x3 = (0, import_react21.useMemo)(function() {
    var e4 = function(e5) {
  ...
  return (0, import_react21.useEffect)(function() {
    return H3;
  }, [H3]), import_react21.default.createElement("div", u3({}, s4, { onTouchStart: C2, onMouseDown: C2, className: "react-colorful__interactive", ref: m4, onKeyDown: E2, tabIndex: 0, role: "slider" }));
});
var g3 = function(e4) {
...
var p3 = function(r4) {
  ...
  return import_react21.default.createElement("div", { className: l4, style: { top: 100 * a4 + "%", left: 100 * n4 + "%" } }, import_react21.default.createElement("div", { className: "react-colorful__pointer-fill", style: { backgroundColor: t4 } }));
};
...
var S3 = import_react21.default.memo(function(r4) {
  var t4 = r4.hue, n4 = r4.onChange, o4 = g3(["react-colorful__hue", r4.className]);
  return import_react21.default.createElement("div", { className: o4 }, import_react21.default.createElement(m3, { onMove: function(e4) {
    n4({ h: 360 * e4.left });
  }, onKey: function(e4) {
    n4({ h: s3(t4 + 360 * e4.left, 0, 360) });
  }, "aria-label": "Hue", "aria-valuenow": b3(t4), "aria-valuemax": "360", "aria-valuemin": "0" }, import_react21.default.createElement(p3, { className: "react-colorful__hue-pointer", left: t4 / 360, color: q2({ h: t4, s: 100, v: 100, a: 1 }) })));
});
var T2 = import_react21.default.memo(function(r4) {
  var t4 = r4.hsva, n4 = r4.onChange, o4 = { backgroundColor: q2({ h: t4.h, s: 100, v: 100, a: 1 }) };
  return import_react21.default.createElement("div", { className: "react-colorful__saturation", style: o4 }, import_react21.default.createElement(m3, { onMove: function(e4) {
    n4({ s: 100 * e4.left, v: 100 - 100 * e4.top });
  }, onKey: function(e4) {
    n4({ s: s3(t4.s + 100 * e4.left, 0, 100), v: s3(t4.v - 100 * e4.top, 0, 100) });
  }, "aria-label": "Color", "aria-valuetext": "Saturation " + b3(t4.s) + "%, Brightness " + b3(t4.v) + "%" }, import_react21.default.createElement(p3, { className: "react-colorful__saturation-pointer", top: 1 - t4.v / 100, left: t4.s / 100, color: q2(t4) })));
});
...
function Y2(e4, t4, l4) {
  var u4 = i3(l4), c4 = (0, import_react21.useState)(function() {
    return e4.toHsva(t4);
  }), s4 = c4[0], f4 = c4[1], v4 = (0, import_react21.useRef)({ color: t4, hsva: s4 });
  (0, import_react21.useEffect)(function() {
    if (!e4.equal(t4, v4.current.color)) {
      var r4 = e4.toHsva(t4);
      v4.current = { hsva: r4, color: t4 }, f4(r4);
    }
  }, [t4, e4]), (0, import_react21.useEffect)(function() {
    var r4;
    F2(s4, v4.current.hsva) || e4.equal(r4 = e4.fromHsva(s4), v4.current.color) || (v4.current = { hsva: s4, color: r4 }, u4(r4));
  }, [s4, e4, u4]);
  var d4 = (0, import_react21.useCallback)(function(e5) {
    f4(function(r4) {
...
var R2;
var V2 = "undefined" != typeof window ? import_react21.useLayoutEffect : import_react21.useEffect;
var $3 = function() {
...
var U2 = function(t4) {
  var n4 = t4.className, o4 = t4.colorModel, a4 = t4.color, l4 = void 0 === a4 ? o4.defaultColor : a4, i4 = t4.onChange, s4 = c3(t4, ["className", "colorModel", "color", "onChange"]), f4 = (0, import_react21.useRef)(null);
  Q(f4);
  var v4 = Y2(o4, l4, i4), d4 = v4[0], h4 = v4[1], m4 = g3(["react-colorful", n4]);
  return import_react21.default.createElement("div", u3({}, s4, { ref: f4, className: m4 }), import_react21.default.createElement(T2, { hsva: d4, onChange: h4 }), import_react21.default.createElement(S3, { hue: d4.h, onChange: h4, className: "react-colorful__last-control" }));
};
var ee = function(r4) {
  ...
  return import_react21.default.createElement("div", { className: l4 }, import_react21.default.createElement("div", { className: "react-colorful__alpha-gradient", style: a4 }), import_react21.default.createElement(m3, { onMove: function(e4) {
    o4({ a: e4.left });
  }, onKey: function(e4) {
    o4({ a: s3(n4.a + e4.left) });
  }, "aria-label": "Alpha", "aria-valuetext": u4 + "%", "aria-valuenow": u4, "aria-valuemin": "0", "aria-valuemax": "100" }, import_react21.default.createElement(p3, { className: "react-colorful__alpha-pointer", left: n4.a, color: k3(n4) })));
};
var re = function(t4) {
  var n4 = t4.className, o4 = t4.colorModel, a4 = t4.color, l4 = void 0 === a4 ? o4.defaultColor : a4, i4 = t4.onChange, s4 = c3(t4, ["className", "colorModel", "color", "onChange"]), f4 = (0, import_react21.useRef)(null);
  Q(f4);
  var v4 = Y2(o4, l4, i4), d4 = v4[0], h4 = v4[1], m4 = g3(["react-colorful", n4]);
  return import_react21.default.createElement("div", u3({}, s4, { ref: f4, className: m4 }), import_react21.default.createElement(T2, { hsva: d4, onChange: h4 }), import_react21.default.createElement(S3, { hue: d4.h, onChange: h4 }), import_react21.default.createElement(ee, { hsva: d4, onChange: h4, className: "react-colorful__last-control" }));
};
var xe = { defaultColor: { r: 0, g: 0, b: 0, a: 1 }, toHsva: L2, fromHsva: I3, equal: F2 };
var Ce = function(r4) {
  return import_react21.default.createElement(re, u3({}, r4, { colorModel: xe }));
};
...
var Ne = function(r4) {
  return import_react21.default.createElement(U2, u3({}, r4, { colorModel: Me }));
};
...
function ColorComponent() {
  ...
  return import_react23.default.createElement(Row, {
    input: true
  }, import_react23.default.createElement(Label, null, label), import_react23.default.createElement(PickerContainer, null, import_react23.default.createElement(Color2, {
    value,
    displayValue,
    onChange,
    onUpdate,
...
function ImageComponent() {
  ...
  const clear = (0, import_react23.useCallback)((e4) => {
    e4.stopPropagation();
    onUpdate(void 0);
  }, [onUpdate]);
  const {
...
var MonitorCanvas = (0, import_react23.forwardRef)(function({
  ...
  const min = (0, import_react23.useRef)(initialValue);
  const max = (0, import_react23.useRef)(initialValue);
  ...
  const drawPlot = (0, import_react23.useCallback)((_canvas, _ctx) => {
    ...
    for (let i4 = 0; i4 < points.current.length; i4++) {
      const p4 = range(points.current[i4], min.current, max.current);
...
var Abstract = class {
  constructor(c4, props3, onParse) {
    this.uuid = MathUtils.generateUUID().replace(/-/g, "_");
    this.name = "LayerMaterial";
    this.mode = "normal";
    this.visible = true;
    const defaults = Object.getOwnPropertyNames(c4).filter((e4) => e4.startsWith("u_"));
    const uniforms = defaults.reduce((a4, v4) => {
      var _Object$getOwnPropert;
      let value = (_Object$getOwnPropert = Object.getOwnPropertyDescriptor(c4, v4)) == null ? void 0 : _Object$getOwnPropert.value;
    ...
    Object.keys(uniforms).map((key) => {
      ...
      properties[propName] = {
        set: (v4) => {
          this.uniforms[`u_${this.uuid}_${propName}`].value = getUniform(v4);
        },
        get: () => {
  ...
  buildShaders(constructor) {
    var _this$onParse;
    const shaders = Object.getOwnPropertyNames(constructor).filter((e4) => e4 === "fragmentShader" || e4 === "vertexShader").reduce((a4, v4) => {
      var _Object$getOwnPropert2;
      return {
        ...a4,
        [v4]: (_Object$getOwnPropert2 = Object.getOwnPropertyDescriptor(constructor, v4)) == null ? void 0 : _Object$getOwnPropert2.value
      };
    }, {});
    const tokens = {
    ...
    const mainIndex = {
      vert: funcs.vert.map((e4) => {
        return e4.name;
      }).indexOf("main"),
      frag: funcs.frag.map((e4) => {
        return e4.name;
      }).indexOf("main")
    };
    const variables = {
  ...
  processFinal(shader, isVertex) {
    const s4 = shader.replace(/\sf_/gm, ` f_${this.uuid}_`).replace(/\(f_/gm, `(f_${this.uuid}_`);
    const returnValue = s4.match(/^.*return.*$/gm);
    let sReplaced = s4.replace(/^.*return.*$/gm, "");
  ...
  getBlendMode(b4, a4) {
    switch (this.mode) {
      default:
      case "normal":
        return `lamina_blend_alpha(${a4}, ${b4}, ${b4}.a)`;
      case "add":
        return `lamina_blend_add(${a4}, ${b4}, ${b4}.a)`;
      case "subtract":
        return `lamina_blend_subtract(${a4}, ${b4}, ${b4}.a)`;
      case "multiply":
        return `lamina_blend_multiply(${a4}, ${b4}, ${b4}.a)`;
      case "lighten":
        return `lamina_blend_lighten(${a4}, ${b4}, ${b4}.a)`;
      case "darken":
        return `lamina_blend_darken(${a4}, ${b4}, ${b4}.a)`;
      case "divide":
        return `lamina_blend_divide(${a4}, ${b4}, ${b4}.a)`;
      case "overlay":
        return `lamina_blend_overlay(${a4}, ${b4}, ${b4}.a)`;
      case "screen":
        return `lamina_blend_screen(${a4}, ${b4}, ${b4}.a)`;
      case "softlight":
        return `lamina_blend_softlight(${a4}, ${b4}, ${b4}.a)`;
      case "reflect":
        return `lamina_blend_reflect(${a4}, ${b4}, ${b4}.a)`;
      case "negation":
        return `lamina_blend_negation(${a4}, ${b4}, ${b4}.a)`;
    }
  }
  getSchema() {
  ...
  serialize() {
    ...
    nonUniformPropKeys = nonUniformPropKeys.filter((e4) => !["uuid", "uniforms", "schema", "fragmentShader", "vertexShader", "fragmentVariables", "vertexVariables", "attribs", "events", "__r3f", "onParse"].includes(e4));
    const nonUniformProps = {};
    nonUniformPropKeys.forEach((k4) => {
      nonUniformProps[k4] = this[k4];
    });
    const props3 = {};
...
var LayerMaterial$1 = class extends CustomShaderMaterial {
  ...
  genShaders() {
    ...
    let fragmentShader = "";
    let uniforms = {};
    this.layers.filter((l4) => l4.visible).forEach((l4) => {
      vertexVariables += l4.vertexVariables + "\n";
      fragmentVariables += l4.fragmentVariables + "\n";
      vertexShader += l4.vertexShader + "\n";
      fragmentShader += l4.fragmentShader + "\n";
      uniforms = {
        ...uniforms,
        ...l4.uniforms
      };
  ...
  set color(v4) {
    ...
    if ((_this$uniforms = this.uniforms) != null && (_this$uniforms$u_lami = _this$uniforms.u_lamina_color) != null && _this$uniforms$u_lami.value)
      this.uniforms.u_lamina_color.value = typeof v4 === "string" ? new Color(v4).convertSRGBToLinear() : v4;
  }
  get color() {
  ...
  set alpha(v4) {
    this.uniforms.u_lamina_alpha.value = v4;
  }
  get alpha() {
...
function getJSPropsFromLayer(layer) {
  ...
  entries.forEach(([key, val], idx) => {
    ...
    if (key.includes("color")) {
      const v4 = typeof val === "string" ? val : "#" + val.getHexString();
      props3 += `${key}: ${JSON.stringify(v4)},${eol}`;
    } else {
...
function serializedLayersToJS(layers, material) {
  ...
  const jsLayers = `${layers.map((l4) => {
    return `new ${l4.constructor}({
      ${getJSPropsFromLayer(l4)}
      })`;
  }).join(",\n		")}`;
  const js = `
  new LayerMaterial({
...
function DynamicLeva({
  ...
  useControls(name, () => {
    const o4 = {};
    layers.forEach((layer, i4) => {
      const n4 = `${layer.label} ~${i4}`;
      o4[n4] = layer;
      o4[n4].onChange = () => setUpdate([`${name}.${n4}`, layer.label]);
    });
    return o4;
  }, {
    store
...
var DebugLayerMaterial = import_react26.default.forwardRef(({
  children,
  ...props3
}, forwardRef3) => {
  var _ref$current, _ref$current2, _ref$current3;
  const ref = import_react26.default.useRef(null);
  (0, import_react26.useImperativeHandle)(forwardRef3, () => ref.current);
  const store = useCreateStore();
  const [layers, setLayers] = import_react26.default.useState({});
  const [path, setPath] = import_react26.default.useState(["", ""]);
  const textureLoader = (0, import_react26.useMemo)(() => new TextureLoader(), []);
  useControls({
    "Copy JSX": button(() => {
      const serialized = ref.current.layers.map((l4) => l4.serialize());
  ...
  const [args, otherProps] = (0, import_react26.useMemo)(() => getLayerMaterialArgs({
    ...props3,
    lighting: Lighting
  }), [props3, Lighting]);
  import_react26.default.useEffect(() => {
    ...
    const schema3 = {};
    layers2.forEach((layer, i4) => {
      if (layer.getSchema)
        schema3[`${layer.name} ~${i4}`] = layer.getSchema();
    });
    setLayers(schema3);
  }, [children]);
  import_react26.default.useEffect(() => {
        ...
        (async () => {
          try {
            if (updatedData.value) {
              const t4 = await textureLoader.loadAsync(updatedData.value);
              layer[property] = t4;
              uniform.value = t4;
            } else {
  ...
  import_react26.default.useLayoutEffect(() => {
    ...
    if (root) {
      ...
      levaRoot.render(import_react26.default.createElement(LevaPanel, {
        titleBar: {
  ...
  return import_react26.default.createElement(import_react26.default.Fragment, null, Object.entries(layers).map(([name, layers2], i4) => import_react26.default.createElement(DynamicLeva, {
    key: `${name} ~${i4}`,
    name,
    layers: layers2,
    store,
    setUpdate: setPath
  })), import_react26.default.createElement("layerMaterial", _extends({
    args: [args],
    ref
  }, otherProps), children));
});
...
var LayerMaterial = import_react26.default.forwardRef(({
  children,
  ...props3
}, forwardRef3) => {
  const ref = import_react26.default.useRef(null);
  ...
  const [args, otherProps] = (0, import_react26.useMemo)(() => getLayerMaterialArgs(props3), [props3]);
  return import_react26.default.createElement("layerMaterial", _extends({
    args: [args],
    ref
  }, otherProps), children);
});
...
var Depth = import_react26.default.forwardRef((props3, forwardRef3) => {
  return import_react26.default.createElement("depth_", _extends({
    args: getNonUniformArgs(props3),
    ref: forwardRef3
  }, props3));
});
var Color3 = import_react26.default.forwardRef((props3, ref) => {
  return import_react26.default.createElement("color_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Noise = import_react26.default.forwardRef((props3, ref) => {
  return import_react26.default.createElement("noise_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Fresnel = import_react26.default.forwardRef((props3, ref) => {
  return import_react26.default.createElement("fresnel_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Gradient = import_react26.default.forwardRef((props3, ref) => {
  return import_react26.default.createElement("gradient_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Matcap = import_react26.default.forwardRef((props3, ref) => {
  return import_react26.default.createElement("matcap_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Texture2 = import_react26.default.forwardRef((props3, ref) => {
  return import_react26.default.createElement("texture_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Displace = import_react26.default.forwardRef((props3, ref) => {
  return import_react26.default.createElement("displace_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
var Normal = import_react26.default.forwardRef((props3, ref) => {
  return import_react26.default.createElement("normal_", _extends({
    ref,
    args: getNonUniformArgs(props3)
  }, props3));
});
