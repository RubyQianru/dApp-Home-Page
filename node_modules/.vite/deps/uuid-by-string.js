...
var require_lib = __commonJS({
  "node_modules/uuid-by-string/src/lib.js"(exports2, module2) {
    var md5 = require_md5();
    ...
    var stringToCharBuffer = function(str) {
      ...
      var buffer2 = new Uint8Array(escapedStr.length);
    ...
    var hashToUuid = function(hashBuffer, version) {
      return (
        ...
        uint8ToHex(hashBuffer[6] & 15 | parseInt(version * 10, 16)) + uint8ToHex(hashBuffer[7]) + "-" + // The high field of the clock sequence multiplexed with the variant
        uint8ToHex(hashBuffer[8] & 63 | 128) + // The low field of the clock sequence
...
var require_src = __commonJS({
  "node_modules/uuid-by-string/src/index.js"(exports2, module2) {
    var lib = require_lib();
    ...
    function generateUuid(target, namespace, version) {
      ...
      if (typeof namespace === "number") {
        return generateUuid(target, void 0, namespace);
      }
      if (version == null) {
      ...
      var buffer2 = lib.concatBuffers(namespaceCharBuffer, targetCharBuffer);
      var hash = version === 3 ? lib.md5Hash(buffer2) : lib.sha1Hash(buffer2);
      return lib.hashToUuid(hash, version);
    }
    module2.exports = generateUuid;
  }
});
...
js-sha1/src/sha1.js:
   ...
   *)
*/
//# sourceMappingURL=uuid-by-string.js.map
